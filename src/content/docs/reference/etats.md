...
- **Résistance** : Les créatures de [rang céleste](../../personnage/rang) élevé peuvent résister à certains états
...
- Les attaques au corps à corps contre la créature ont un [avantage](../../mecanique/resolution#avantage)
- Les attaques à distance contre la créature ont un [désavantage](../../mecanique/resolution#désavantage) si l'attaquant est à plus de 6m
...
- Désavantage sur tous les jets d'attaque et de [caractéristiques](../../personnage/caracteristiques) physiques
...
- Échec automatique des jets de Force et Agilité
- Les attaques contre la créature ont un avantage
- Toute attaque au corps à corps qui touche est un [coup critique](../../mecanique/resolution#réussite-critique)
...
**Fin :** [Intervention divine](../../mecanique/resolution#interventions-divine-et-démoniaque), rituels de purification, ou conditions très spécifiques.
...
- Tous les pouvoirs divins ont un [dé d'intensité](../../mecanique/resolution) explosif
...
- Doit [se réincarner](../../personnage/reincarnation) dans les 10 tours ou retourner dans son plan d'origine

**Fin :** [Réincarnation](../../personnage/reincarnation) dans un nouvel hôte.
...
- **[Points de Vie](../../mecanique/blessures)** : Les objets ont des PV selon leur taille et résistance
...
- **[Compétence](../../mecanique/competences)** : Artisanat approprié
